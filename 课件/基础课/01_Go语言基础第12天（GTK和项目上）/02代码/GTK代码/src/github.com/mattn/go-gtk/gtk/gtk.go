...
// add by mike
func WindowFromObject(object *glib.GObject) *Window {
	return &Window{Bin{Container{Widget{C.toGWidget(object.Object)}}}}
}
...
// add by mike
func ImageFromObject(object *glib.GObject) *Image {
	return &Image{Misc{Widget{C.toGWidget(object.Object)}}}
}
...
// add by mike
func LabelFromObject(object *glib.GObject) *Label {
	return &Label{Misc{Widget{C.toGWidget(object.Object)}}}
}
...
// add by mike
func ProgressBarFromObject(object *glib.GObject) *ProgressBar {
	return &ProgressBar{Widget{C.toGWidget(object.Object)}}
}
...
// add by mike
func ButtonFromObject(object *glib.GObject) *Button {
	return newButtonInternal(C.toGWidget(object.Object))
}
...
// add by mike 修改按钮字体大小
func (v *Button) SetLabelFontSize(size int) {
	v.GetChild().ModifyFontSize(size)
}
...
// add by mike
func EntryFromObject(object *glib.GObject) *Entry {
	w := Widget{C.toGWidget(object.Object)}
...
// add by mike
func HBoxFromObject(object *glib.GObject) *HBox {
	return &HBox{Box{Container{Widget{C.toGWidget(object.Object)}}}}
}
...
// add by mike
func VBoxFromObject(object *glib.GObject) *VBox {
	return &VBox{Box{Container{Widget{C.toGWidget(object.Object)}}}}
}
...
// add by mike
func FixedFromObject(object *glib.GObject) *Fixed {
	return &Fixed{Container{Widget{C.toGWidget(object.Object)}}}
}
...
// add by mike
func TableFromObject(object *glib.GObject) *Table {
	return &Table{Container{Widget{C.toGWidget(object.Object)}}}
}
...
// add by mike, 设置控件字体大小
func (v *Widget) ModifyFontSize(size int) {
	pg := pango.NewFontDescription()
	pg.SetSize(size * 1024)
	C.gtk_widget_modify_font(v.GWidget, (*C.PangoFontDescription)(unsafe.Pointer(pg.GFontDescription)))
	pg.Free()
}
